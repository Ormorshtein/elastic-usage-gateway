...
def build_saved_objects(products_dv_id: str, usage_dv_id: str, logs_dv_id: str, orders_dv_id: str, diff_dv_id: str = "dv-mapping-diff", rec_dv_id: str = "dv-recommendations", arch_dv_id: str = "dv-index-arch") -> list[dict]:
    ...
    objects.append(_markdown(
        ...
        "codec choices, mapping limits, usage-based optimizations, and cluster health.\n\n"
        ...
        "too large (>50 GB) slows recoveries and merges. Also checks document count per shard.\n"
        "- **settings_audit** — Are your index settings correct? Checks replicas, codec, field limits, `_source`, "
        "translog durability, segment counts (force merge), and merge policy configuration.\n"
        ...
        "- **cluster_health** — Cluster-wide checks: node-level shard counts "
        "(shown as index group `_cluster`).\n\n"
        "**How to use this dashboard:**\n"
